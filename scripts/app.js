...
(function() {
  ...
  var app = {
    ...
    removeDialog: document.querySelector('.remove-dialog-container'),
  ...
  document.getElementById('butRemove').addEventListener('click', function() {
    // Open/show the remove confirm dialog
  ...
  document.getElementById('butRemoveCity').addEventListener('click', function() {
    if (!app.selectedCity) return app.toggleRemoveDialog(false);
    
    var key = app.selectedCity.querySelector('.city-key').innerText;
    app.selectedCity.parentNode.removeChild(app.selectedCity);
    delete app.visibleCards[key];
    app.selectedCities = app.selectedCities.filter(function(city) { return city.key !== key });
    app.saveSelectedCities();
    // Close the add new city dialog
  ...
  // Toggles the visibility of the remove confirm dialog.
  app.toggleRemoveDialog = function(visible) {
    if (!app.selectedCity) return;
    if (visible) {
      app.removeDialog.querySelector(".dialog-body").textContent = app.selectedCity.querySelector(".location").textContent;
      app.removeDialog.classList.add('remove-dialog-container--visible');
    } else {
      app.removeDialog.classList.remove('remove-dialog-container--visible');
    }
  };
